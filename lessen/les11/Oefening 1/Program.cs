...
namespace les11
{
    ...
    public class Metro : IBuilder
    {
        ...
        public void Weer()
        {
            this._krant.Add("Het weer voor dag x");
            this._krant.Add("Het weer voor dag x");
            this._krant.Add("Het weer voor dag x");
            this._krant.Add("Het weer voor dag x");
            this._krant.Add("Het weer voor dag x");
    ...
    public class Destandaard : IBuilder
    {
        private Krant _krant = new Krant();
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var builderStandaard = new Destandaard();
            director.Builder = builderMetro;
            director.Builder = builderStandaard;
            
            Console.WriteLine("Metro basic product:");
            director.metro();
            Console.WriteLine(builderMetro.GetProduct().ListParts());

            Console.WriteLine("Metro full featured product:");
            director.buildFullFeaturedProduct();
            Console.WriteLine(builderMetro.GetProduct().ListParts());


            Console.WriteLine("De Standaard basic product:");
            director.destandaard();
            Console.WriteLine(builderStandaard.GetProduct().ListParts());

            Console.WriteLine("De Standaard full featured product:");
            director.buildFullFeaturedProduct();
            Console.WriteLine(builderStandaard.GetProduct().ListParts());
            ...
            // builderMetro.KranteKop();
            // builderMetro.NieuwsArtikels();
            // Console.Write(builderMetro.GetProduct().ListParts());
        }
    }
}
